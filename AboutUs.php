...
.about-us-container {
    ...
    /* margin-top: 166px; */ /* Remove this, rely on global main style */
...
.leader-bio-content {
    max-height: 0;
    overflow: hidden;
    transition: max-height 0.5s ease-out, padding-top 0.5s ease-out, margin-top 0.5s ease-out, border-top-width 0.1s ease-out;
    padding-top: 0;
    margin-top: 0;
