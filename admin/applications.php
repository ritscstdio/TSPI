                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <?php if ($app['status'] === 'pending'): ?>
                                            <a href="verify_application.php?id=<?php echo $app['id']; ?>&action=approved" class="btn-icon" title="Approve"><i class="fas fa-check"></i></a>
                                            <a href="verify_application.php?id=<?php echo $app['id']; ?>&action=rejected" class="btn-icon" title="Reject"><i class="fas fa-ban"></i></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
