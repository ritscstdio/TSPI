        ...
        <?php foreach ($latest_contents as $art): ?>
            ...
            <div class="news-card" style="background-image: url('<?php echo $bg; ?>');">
                ...
                <div class="news-card-desc">
                    ...
                    <a href="<?php echo clean_url('/content'); ?>?slug=<?php echo $art['slug']; ?>" class="cta-button read-this-btn">Read this!</a>
                </div>
            </div>
        <?php endforeach; ?>
        </div>
        <div style="text-align: center; margin-top: 1.5rem;">
            <a href="<?php echo clean_url('/news.php'); ?>" class="read-more-news-link">Read more?</a>
        </div>
    </section>
    ...
    <section class="message-section">
        <div class="message-content">
            ...
            <div class="message-text">
                ...
                <a href="<?php echo clean_url('/AboutUs.php#leader-atty-lamberto-l-meer'); ?>" class="read-more">Read More <span class="read-more-arrow">→</span></a>
            </div>
        </div>
    </section>
    ...
    <section class="message-section reverse">
        <div class="message-content">
            <div class="message-text">
                ...
                <a href="<?php echo clean_url('/AboutUs.php#leader-rene-e-cristobal'); ?>" class="read-more">Read More <span class="read-more-arrow">→</span></a>
            </div>
            <div class="message-image">
