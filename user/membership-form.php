            ...
            <form method="post" action="" id="membership-form">
                ...
                <div class="form-page">
                    ...
                    <div class="form-row">
                        <div class="form-col-2">
                            <div class="form-group">
                                <label for="member_signature_upload">Upload Member's Signature (Image File)</label>
                                <input type="file" id="member_signature_upload" name="member_signature_upload" accept="image/*" class="form-control">
                            </div>
                        </div>
                        <div class="form-col-2">
                            <div class="form-group">
                                <label for="beneficiary_signature_upload">Upload Beneficiary's Signature (Image File)</label>
                                <input type="file" id="beneficiary_signature_upload" name="beneficiary_signature_upload" accept="image/*" class="form-control">
                            </div>
                        </div>
                    </div>
            ...
            if (otherValidIdCount < maxOtherValidIds) {
                ...
                newValidIdDiv.querySelector('.remove-valid-id-btn').addEventListener('click', function() {
                    ...
                    if (otherValidIdCount === 0) {
                        ...
                        addOtherValidIdBtn.textContent = 'Do you have other Valid IDs?';
