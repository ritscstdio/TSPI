    ...
    <div class="email-test-container">
        ...
        <?php elseif ($result === false): ?>
            <div class="message error">
                ...
                <p>Check your PHP error log for more details.</p>
        ...
        <div class="config-info">
            ...
            <h3>Email Log</h3>
            <p>Recent email attempts are logged in: <code>user/email_log.txt</code></p>
            <?php 
            $log_file = __DIR__ . '/email_log.txt';
            if (file_exists($log_file)): 
                $log_content = file_get_contents($log_file);
                $log_entries = array_filter(explode("\n\n", $log_content));
                $log_entries = array_slice($log_entries, -5); // Last 5 entries
            ?>
